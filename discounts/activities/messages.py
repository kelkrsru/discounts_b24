MESSAGES_FOR_BP = {
    ...
    'products_in_deal_null': 'Ошибка: Нет товаров в сделке',
    ...
    'wrong_inn': 'Компания с данным ИНН уже существует в БД',
}
...
MESSAGES_FOR_LOG = {
    ...
    'products_in_deal_null': 'Нет товаров в сделке',
    ...
    'get_active_nomenclature_groups': 'Полученные активные номенклатурные '
                                      'группы:\n',
    ...
    'volumes_no_db': 'По компании {} накопления не найдены в БД приложения',
    'get_volume': 'Полученный объем {} по номенклатурной группе {} и '
                  'компании {}',
    'get_volumes': 'Полученный объем {} по компании {}',
